    ...
    <template #body>
      <div class="space-y-4">
        ...
        <UAlert
          ...
          variant="soft"
          icon="i-lucide-info"
          title="Comment réactiver ?"
          description="Vous pouvez autoriser les notifications à tout moment dans les paramètres de votre navigateur, puis revenir dans les Paramètres de Tumulte."
        />
      </div>
    </template>
