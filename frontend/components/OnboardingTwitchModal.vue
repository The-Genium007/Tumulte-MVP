      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-3">
            <UIcon name="i-lucide-party-popper" class="size-8 text-secondary-600 dark:text-secondary-400" />
            <div>
          ...
          <div class="bg-subtle rounded-lg p-4 space-y-3">
            ...
            <ul class="space-y-2">
              <li class="flex items-start gap-2 text-sm text-muted">
                <UIcon name="i-lucide-vote" class="size-4 text-secondary-600 dark:text-secondary-400 mt-0.5 shrink-0" />
              ...
              <li class="flex items-start gap-2 text-sm text-muted">
                <UIcon name="i-lucide-zap" class="size-4 text-secondary-600 dark:text-secondary-400 mt-0.5 shrink-0" />
