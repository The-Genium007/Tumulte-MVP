...
test.describe('Poll Launch Flow', () => {
  test.describe('Public pages', () => {
    test('should redirect to login when accessing poll create without auth', async ({ page }) => {
  ...
  test.describe('Authenticated pages (require backend)', () => {
    ...
    test.skip('should display create poll template button', async ({ page }) => {
      await page.goto('/mj/campaigns')
      await page.waitForTimeout(2000)
    ...
    test.skip('should display streamers authorization status', async ({ page }) => {
      await page.goto('/mj/campaigns')
      await page.waitForTimeout(2000)

      const viewButton = page.getByRole('button', { name: /voir.*membres/i }).first()
    ...
    test.skip('should display final results after poll ends', async ({ page }) => {
      await page.goto('/mj/campaigns')
      await page.waitForTimeout(2000)
