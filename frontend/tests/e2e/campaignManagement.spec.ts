...
test.describe('Campaign Management', () => {
  ...
  test.describe('Authenticated pages (require backend)', () => {
    ...
    test.skip('should display campaigns list page when authenticated', async ({ page }) => {
    ...
    test.skip('should display empty state when no campaigns exist', async ({ page }) => {
      await page.goto('/mj/campaigns')
    ...
    test.skip('should display members in campaign details', async ({ page }) => {
      await page.goto('/mj/campaigns')
      await page.waitForTimeout(2000)
