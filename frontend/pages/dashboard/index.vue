      ...
      <UCard v-if="invitationCount > 0">
        ...
        >
          <template #description>
            <div
              class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-2"
            >
                  ...
                  >
                    <div class="flex items-center gap-2">
                      ...
                      <span class="font-mono text-base">{{
                        formatTime(status.remainingSeconds || 0)
                      }}</span>
                    </div>
                  </UBadge>
          ...
          <div v-if="overlayUrl" class="space-y-3">
            <div class="flex flex-col sm:flex-row gap-2">
              <div class="flex-1 relative min-w-0">
                <div
                  class="flex items-center gap-2 px-3.5 py-2.5 bg-primary-100 rounded-lg text-primary-400 font-mono text-sm overflow-x-auto"
                >
          ...
          <div class="pt-4 border-t border-default space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:items-start">
              ...
              <UAlert color="warning" variant="soft" icon="i-lucide-flask-conical" class="flex-1">
                ...
                <template #description>
                  <p class="text-sm">
                    Des bugs peuvent survenir. Utilisez le
                    <button
                      class="underline font-medium hover:text-warning-600"
                      @click="openSupport"
                    >
                      support
                    </button>
    ...
    <template #content>
      <UCard>
        ...
        <ol class="list-decimal list-inside space-y-3 text-secondary text-sm sm:text-base">
          ...
          <li>
            Dans OBS Studio, ajoutez une nouvelle source →
            <strong class="text-primary">"Navigateur"</strong>
          </li>
          <li>Collez l'URL dans le champ "URL"</li>
          <li>
            Définissez la largeur à <strong class="text-primary">1920</strong> et la hauteur à
            <strong class="text-primary">1080</strong>
          </li>
          <li>Activez <strong class="text-primary">"Contrôler l'audio via OBS"</strong></li>
          <li>Cliquez sur "OK"</li>
          <li class="text-success-500">
            L'overlay apparaîtra automatiquement quand le MJ lancera un sondage
          </li>
        </ol>
