<template>
  <div class="min-h-screen">
    <div class="max-w-300 mx-auto space-y-6">
      ...
      <UCard>
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-3xl font-bold text-primary">Ajouter une campagne</h1>
            <p class="text-muted mt-1">Importez une campagne depuis votre VTT</p>
          </div>
        </div>
      </UCard>
      ...
      <UCard v-else-if="connections.length === 0">
        <div class="flex flex-col items-center justify-center py-12 px-6 text-center">
          ...
          <div class="flex flex-col items-center gap-4">
            <h3 class="text-lg font-semibold text-primary">Choisissez votre VTT</h3>
        ...
        <UCard>
          ...
          <div v-if="availableCampaigns.length > 0" class="space-y-8">
            <div v-for="(vttGroup, index) in availableCampaigns" :key="vttGroup.connectionId">
              ...
              <div v-if="index > 0" class="h-px bg-primary-500 my-8" />
    ...
    <UModal v-model:open="showAddVttModal">
      <template #header>
        <h3 class="text-xl font-bold text-primary">Ajouter une connexion VTT</h3>
      </template>

      <template #body>
        <div class="space-y-6">
          <p class="text-secondary">
            Sélectionnez votre Virtual Tabletop pour configurer une nouvelle connexion.
          </p>
