...
export const mockMemberPartnerAuthorized: CampaignMembership = {
  ...
  pollAuthorizationGrantedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
  pollAuthorizationExpiresAt: new Date(Date.now() + 10 * 60 * 60 * 1000).toISOString(),
  isPollAuthorized: true,
...
export const mockMemberAffiliateShortTime: CampaignMembership = {
  ...
  pollAuthorizationGrantedAt: new Date(Date.now() - 11 * 60 * 60 * 1000).toISOString(),
  pollAuthorizationExpiresAt: new Date(Date.now() + 45 * 60 * 1000).toISOString(),
  isPollAuthorized: true,
...
export const mockMemberLive: CampaignMembership = {
  ...
  pollAuthorizationGrantedAt: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
  pollAuthorizationExpiresAt: new Date(Date.now() + 11 * 60 * 60 * 1000).toISOString(),
  isPollAuthorized: true,
