...
export const SUPPORT_ERROR_MESSAGES: Record<SupportActionType, string> = {
  ...
  campaign_fetch_detail: 'Une erreur est survenue lors du chargement de la campagne.',
  campaign_create: 'Une erreur est survenue lors de la création de la campagne.',
  campaign_update: 'Une erreur est survenue lors de la modification de la campagne.',
  campaign_delete: 'Une erreur est survenue lors de la suppression de la campagne.',
  campaign_invite: "Une erreur est survenue lors de l'invitation du streamer.",
  campaign_members_fetch: 'Une erreur est survenue lors du chargement des membres.',
  ...
  session_update: 'Une erreur est survenue lors de la modification de la session.',
  session_delete: 'Une erreur est survenue lors de la suppression de la session.',
  ...
  template_add_to_session: "Une erreur est survenue lors de l'ajout à la session.",
  ...
  poll_fetch_results: 'Une erreur est survenue lors du chargement des résultats.',
  ...
  // ===== STREAMER CAMPAGNES =====
  streamer_invitations_fetch: 'Une erreur est survenue lors du chargement des invitations.',
  ...
  streamer_campaigns_fetch: 'Une erreur est survenue lors du chargement des campagnes.',
  streamer_campaign_leave: 'Une erreur est survenue lors du départ de la campagne.',

  // ===== AUTORISATION TWITCH =====
  authorization_status_fetch: 'Une erreur est survenue lors du chargement du statut.',
  ...
  // ===== NOTIFICATIONS PUSH =====
  push_permission_request: 'Une erreur est survenue lors de la demande de permission.',
  push_subscribe: "Une erreur est survenue lors de l'abonnement aux notifications.",
  push_unsubscribe: 'Une erreur est survenue lors du désabonnement.',
  push_subscriptions_fetch: 'Une erreur est survenue lors du chargement des appareils.',
  push_subscription_delete: "Une erreur est survenue lors de la suppression de l'appareil.",
  push_preferences_update: 'Une erreur est survenue lors de la mise à jour des préférences.',
  ...
  websocket_message_parse: 'Une erreur est survenue lors de la lecture des données.',
  websocket_reconnect: 'Une erreur est survenue lors de la reconnexion.',

  // ===== HEALTH CHECK =====
  health_check_global: 'Une erreur est survenue lors de la vérification système.',
  ...
  // ===== OVERLAY =====
  overlay_url_fetch: "Une erreur est survenue lors de la génération de l'URL overlay.",
  overlay_campaigns_fetch: 'Une erreur est survenue lors du chargement overlay.',
  overlay_poll_subscribe: "Une erreur est survenue lors de l'écoute des sondages.",
  overlay_poll_display: "Une erreur est survenue lors de l'affichage du sondage.",

  // ===== OVERLAY STUDIO =====
  overlay_configs_fetch: 'Une erreur est survenue lors du chargement des configurations.',
  overlay_config_fetch: 'Une erreur est survenue lors du chargement de la configuration.',
  overlay_config_create: 'Une erreur est survenue lors de la création de la configuration.',
  overlay_config_update: 'Une erreur est survenue lors de la mise à jour de la configuration.',
  overlay_config_delete: 'Une erreur est survenue lors de la suppression de la configuration.',
  overlay_config_activate: "Une erreur est survenue lors de l'activation de la configuration.",

  // ===== COMPTE =====
  account_delete: 'Une erreur est survenue lors de la suppression du compte.',
  settings_update: 'Une erreur est survenue lors de la mise à jour des paramètres.',

  // ===== SUPPORT =====
  support_send: "Une erreur est survenue lors de l'envoi du ticket.",

  // ===== PROCESSUS FOND =====
  token_refresh_auto: 'Une erreur est survenue lors du renouvellement automatique.',
  poll_polling_cycle: 'Une erreur est survenue lors de la récupération des votes.',
  poll_aggregation: "Une erreur est survenue lors de l'agrégation des résultats.",
  twitch_chat_message: "Une erreur est survenue lors de l'envoi au chat.",
  push_notification_send: "Une erreur est survenue lors de l'envoi de notification.",
