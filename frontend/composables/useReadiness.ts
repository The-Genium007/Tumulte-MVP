...
export const useReadiness = () => {
  ...
  const fetchReadiness = async (
    ...
    try {
      const response = await fetch(
        `${API_URL}/mj/campaigns/${campaignId}/streamers/readiness`,
        {
          credentials: "include",
        },
      );
      ...
      error.value =
        err instanceof Error ? err.message : "Unknown error fetching readiness";
      throw err;
    } finally {
  ...
  const notifyUnready = async (
    ...
    try {
      const response = await fetch(
        `${API_URL}/mj/campaigns/${campaignId}/notify-unready`,
        {
          method: "POST",
          credentials: "include",
        },
      ...
      error.value =
        err instanceof Error
          ? err.message
          : "Unknown error notifying streamers";
      throw err;
    }
  };
  ...
  const launchSession = async (
    ...
    try {
      ...
      error.value =
        err instanceof Error ? err.message : "Unknown error launching session";
      throw err;
    }
  };
