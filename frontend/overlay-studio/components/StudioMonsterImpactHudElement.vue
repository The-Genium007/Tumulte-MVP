    ...
    >
      <div class="impact-hud-element" :style="containerStyle" @pointerdown.stop="handlePointerDown">
        ...
        <div class="impact-container" :style="innerContainerStyle">
          <div class="impact-title" :style="titleStyle">⚔️ COMBAT !</div>
          <div class="impact-detail" :style="detailStyle">+2 CA</div>
        </div>
      </div>
    </Html>
  </TresGroup>
...
import type { OverlayElement, MonsterImpactHudProperties } from '../types'
...
// Extract properties
const elementProps = computed(() => props.element.properties as MonsterImpactHudProperties)
