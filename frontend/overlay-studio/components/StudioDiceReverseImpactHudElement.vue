    ...
    >
      <div class="impact-hud-element" :style="containerStyle" @pointerdown.stop="handlePointerDown">
        ...
        <div class="impact-container" :style="innerContainerStyle">
          <div class="impact-title" :style="titleStyle">🎲 INVERSION DE DÉ !</div>
          <div class="impact-detail" :style="detailStyle">20 → 1</div>
        </div>
      </div>
    </Html>
  </TresGroup>
...
import type { OverlayElement, DiceReverseImpactHudProperties } from '../types'
...
// Extract properties
const elementProps = computed(() => props.element.properties as DiceReverseImpactHudProperties)
