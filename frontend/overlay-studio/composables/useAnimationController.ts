...
export const useAnimationController = (
  ...
  const playEntry = async (): Promise<void> => {
    ...
    await new Promise((resolve) =>
      setTimeout(resolve, entryAnim.soundLeadTime * 1000),
    );
    ...
    await new Promise((resolve) =>
      setTimeout(resolve, entryAnim.animation.duration * 1000),
    );
  ...
  const playExit = async (): Promise<void> => {
    ...
    await new Promise((resolve) =>
      setTimeout(resolve, exitAnim.animation.duration * 1000),
    );
