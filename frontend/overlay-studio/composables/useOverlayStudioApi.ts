...
export const useOverlayStudioApi = () => {
   ...
   */
  const autoSave = useDebounceFn(async (id: string, configData: OverlayConfigData) => {
   ...
   */
  const mapResponseToConfig = (response: OverlayConfigResponse): OverlayConfig => ({
    id: response.id,
   ...
   */
  const mapDetailResponseToConfig = (response: OverlayConfigDetailResponse): OverlayConfig => ({
    id: response.id,
    streamerId: response.streamerId,
    name: response.name,
