 ...
 *
 * This is a self-contained version compatible with PIXI v5/v7 (Foundry VTT).
...
function buildFragmentShader(distance, quality) {
...
export class TumulteGlowFilter extends PIXI.Filter {
  ...
  constructor(options = {}) {
    ...
    super(
      vertexShader,
      buildFragmentShader(distance, quality),
      {
